 ...
 * @return mixed
 */
function civicrm_api3_generic_getentitylist($apiRequest) {
  $entity = _civicrm_api_get_entity_name_from_camel($apiRequest['entity']);
  try {
    //if we are in 4.5 or greater then we don't need all the rest of this
    return civicrm_api3($entity, 'getlist', array());
  }
  catch (Exception $e) {
 ...
 * @param $request array
 */
function _civicrm_api3_generic_getentitylist_defaults($entity, &$request) {
 ...
 * @param $request array
 */
function _civicrm_api3_generic_getentitylist_params(&$request) {
 ...
 * @return array
 */
function _civicrm_api3_generic_getentitylist_output($result, $request) {
  $output = array();
